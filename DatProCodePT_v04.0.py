...
def MeanNPeak(df,datum) :
      ...
      print('avarage of the peaks         :',(stat.mean(dat)-scaleUp_std(datum,3)),'bar')
...
#      fl_name=["Results/FullLoad/FL_180/S8.txt"]

#      fl_out='Results/FullLoad/FL_180/PressureTransducers/S8.out'
